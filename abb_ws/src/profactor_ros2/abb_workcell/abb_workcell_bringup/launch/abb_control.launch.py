...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="abb_workcell_bringup",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "rws_ip",
            default_value="192.168.125.20", # Virtual Controller 
    ...
    # TODO compare this approach (from a different example)
    ...
    #TODO restructure launch files
    # - static tf is not really required for abb_control, but it helps to root the robot (for rviz, moveit)
    # Static TF
    static_tf_node = Node(
        package="tf2_ros",
