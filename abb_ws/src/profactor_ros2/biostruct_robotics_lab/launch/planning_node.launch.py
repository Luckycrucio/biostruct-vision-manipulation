...
A launch file for the Planner node.
"""
...
PACKAGE_NAME = "biostruct_robotics_lab"
...
def generate_launch_description():
    ...
    # Planner MQTT client node
    mqtt_params = os.path.join(package_path, 'config', 'mqtt_client_params.yaml')
